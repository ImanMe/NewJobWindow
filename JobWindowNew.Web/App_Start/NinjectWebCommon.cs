using JobWindowNew.DAL.Persistence;
using JobWindowNew.DAL.Persistence.Repositories;
using JobWindowNew.Domain;
using JobWindowNew.Domain.IRepositories;

[assembly: WebActivatorEx.PreApplicationStartMethod(typeof(JobWindowNew.Web.App_Start.NinjectWebCommon), "Start")]
[assembly: WebActivatorEx.ApplicationShutdownMethodAttribute(typeof(JobWindowNew.Web.App_Start.NinjectWebCommon), "Stop")]

namespace JobWindowNew.Web.App_Start
{
    ...
    public static class NinjectWebCommon
    {
        ...
        private static void RegisterServices(IKernel kernel)
        {
            ...
            kernel.Bind<IJobCategoryMapRepository>().To<JobCategoryMapRepository>();
        }
    }
}
